...
export default function ClientEditForm({ person }: ClientEditFormProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      origin_latitude: person.origin_latitude || undefined,
      origin_longitude: person.origin_longitude || undefined,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              type="text"
              placeholder="e.g., Los Angeles, CA or Out of State - Texas"
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <p className="text-xs text-gray-500 mt-1">
              City/state or general area where the client was originally from
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center">
              ...
              />
              <label className="ml-2 block text-sm text-gray-700">
                Verbal ROI for Grossmont Approved
              </label>
            </div>
